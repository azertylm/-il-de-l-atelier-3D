            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2.5 text-xs">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <span className="text-[11px] opacity-75">Historique complet de toutes vos analyses sauvegardées et synchronisées.</span>
                </div>
              </div>
              <div className="flex items-start gap-2">
              ...
              >
                <Cloud className="w-4 h-4 text-[#c9a84c] flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform" />
                <div>
                  <strong className="block font-sans group-hover:text-[#c9a84c] transition-colors">Compte Cloud Multi-Appareils</strong>
                  <span className="text-[11px] opacity-75">Sauvegarde automatique pour PC, tablette et smartphone.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-[#c9a84c]/20">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-sans opacity-80">
                Vous pouvez créer votre compte ou vous connecter à tout moment via le bouton « Compte Cloud » dans l'en-tête pour synchroniser toutes vos données.
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0 flex-wrap">
              {onOpenAccountModal && (
                <button
                  type="button"
                  onClick={onOpenAccountModal}
                  className="px-3 py-1.5 bg-[#c9a84c] text-black hover:bg-white font-bold uppercase tracking-wider text-[10px] transition-colors cursor-pointer shadow"
                >
                  ☁️ Mon Compte Cloud
                </button>
              )}
