          ...
          <div className="flex items-center gap-2">
            {onOpenRsvpPartners && (
              <button
                ...
                className="hidden md:flex items-center gap-1.5 px-3 py-1.5 bg-[#c9a84c] text-black text-xs font-mono font-bold uppercase hover:bg-white transition-colors cursor-pointer"
                title="Gérer les RSVP des invités et les partenaires traiteurs / snacks locaux"
              >
                <Users className="w-3.5 h-3.5" />
                <span>RSVP & Traiteurs</span>
              </button>
            )}
            ...
            {onOpenUrbanCircuit && (
              <button
                ...
                className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 bg-neutral-900 border border-white/20 text-white text-xs font-mono font-bold uppercase hover:bg-white hover:text-black transition-colors cursor-pointer"
                title="Consulter le parcours urbain géolocalisé reliant la galerie à l'architecture"
              >
                <MapPin className="w-3.5 h-3.5 text-[#c9a84c]" />
                <span>Parcours Urbain</span>
              </button>
            )}
